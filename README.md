...
mkdir data
curl -O https://raw.githubusercontent.com/devosduotech/dashhub/v1.0.21/docker-compose.yml
docker compose up -d
```
...
docker run -d \
  ...
  ghcr.io/devosduotech/dashhub:1.0.21
```
...
| Tag | Description |
|-----|-------------|
| `1.0.21` | Current release |
| `latest` | Latest stable release |

Pull the current release:

```bash
docker pull ghcr.io/devosduotech/dashhub:1.0.21
```
