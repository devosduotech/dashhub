...
>
> Last updated: 2026-08-27 | Version: **1.0.21**
>
...
> **DashHub v1.0.21 — Local-First Release.** Intended for a single user on a
...
| Docker image registry | Implemented | `ghcr.io/devosduotech/dashhub` (`1.0.21` + `latest`) |
