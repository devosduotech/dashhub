...
describe('help docs link rewriting', () => {
  ...
  it('routes external .md docs (deployment guide) to GitHub in a new tab', () => {
    ...
    expect(out).toContain('https://github.com/devosduotech/dashhub/blob/v1.0.21/docs/deployment/README.md')
  ...
  it('routes SECURITY.md (with different relative depth) to GitHub', () => {
    ...
    expect(out).toContain('https://github.com/devosduotech/dashhub/blob/v1.0.21/docs/project/SECURITY.md')
    expect(out).toContain('target="_blank"')
  })
